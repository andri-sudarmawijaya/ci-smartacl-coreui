                ...
                <nav class="sidebar-nav">
                    <ul class="nav">
                        ...
                        <?php
                                ...
                                if($submenu->num_rows()>0){
                                    ...
                                    echo "<li class='nav-item nav-dropdown'>
                                            ...
                                            foreach ($submenu->result() as $sub){
                                                ...
                                                echo anchor($sub->url,"<i class='".$sub->icon."'></i> ".$sub->title, array('class' => 'nav-link'));
                                                echo "</li>";
                                            }
                                            echo" </ul>
                                        </li>";
                            ...
                            ?>
                            <li class="nav-item"><?php echo anchor('auth/logout',"<i class='fa fa-sign-out'></i> LOG OUT", array('class' => 'nav-link'));?></li>
