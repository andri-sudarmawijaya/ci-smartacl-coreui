                ...
                <form action="<?php echo base_url('admin/login');?>" method="post">
                    ...
                    <div role="group" class="form-group">
                      <div class="input-group">
                        ...
                        <input id="uid-uw5lvwq9md" type="text" placeholder="Username" name="username" class="form-control" value="">
                      </div>
                    </div>
                    <div role="group" class="form-group">
                      <div class="input-group">
                        ...
                        <input id="uid-u0rbnzin5y9" type="password" placeholder="Password" name="password" class="form-control"> 
                      </div>
                    </div>
                    <div role="group" class="form-group">
                    ...
                    <div class="row">
                      ...
                      <a href="<?php echo base_url('admin/forgot_password');?>">Forgot your password?</a>
                          <a class="btn d-lg-none btn-link" href="<?php echo base_url('admin/register');?>"> Register now!</a>
                      </div>
                    </div>
                  </form>
                </div>
              </div>
              <div class="card text-center py-5 d-md-down-none bg-primary text-white">
                <div class="card-body">
                  <div class="card-body">
                    <h2>Sign up</h2>
