                ...
                <form action="<?php echo base_url('admin/login'); ?>" method="post">
                  ...
                  <div class="row">
                    <div class="text-left col-5">
                      ...
                      <button type="submit" class="btn px-4 btn-primary"><span><i class="fa fa-sign-in" aria-hidden="true"></i></span> Login</button>
                    </div>
              ...
              <div class="card-body">
                <div class="card-body">
                  ...
                  <p>Don't have an account?&nbsp; <br />
                    <a class="btn btn-outline-dark" href="<?php echo base_url('admin/register'); ?>"><span><i class="fa fa-user-plus" aria-hidden="true"></i></span> Sign Up</a>
                  </p>
                </div>
              </div>
            </div>
